...
from generative_place_categorization.prompt.complex_scene_helper_prompt import (
    ComplexSceneHelperPrompt,
)
from generative_place_categorization.prompt.simple_scene_helper_prompt import (
